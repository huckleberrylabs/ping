...
import "./style.css";
import { Settings, SDK, Interfaces } from "@huckleberryai/ping";
...
export class WidgetDetail extends React.Component<Props, State> {
  constructor(props: Props) {
    super(props);
    this.state = {
      sdk: SDK.C(this.props.match.params.id, UUID.C()),
      error: false,
  ...
  async componentDidMount() {
    const settingsMaybe = await this.state.sdk.Settings.Get();
